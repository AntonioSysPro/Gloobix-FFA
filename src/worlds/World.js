...
class World
{
    ...
    liveUpdate ()
    {
        ...
        while ( this.foodCount < this.settings.foodCount )
        {
            const pos = this.getSafeSpawnPos( this.settings.foodMinSize );
            this.addCell( new Food( this, this, pos.x, pos.y ) );
        }
        ...
        while ( this.boosterCount < this.settings.boosterMinCount )
        {
    ...
    */
    ...
    {
        const newBooster = new Booster( this, booster.x, booster.y );
        newBooster.boost.dx = Math.sin( booster.splitAngle );
        newBooster.boost.dy = Math.cos( booster.splitAngle );
        newBooster.boost.d = this.settings.boosterSplitBoost;
        this.addCell( newBooster );
        this.setCellAsBoosting( newBooster );
    }
    ...
    compileStatistics ()
    {
        ...
        this.stats.gamemode = this.settings.serverName;
