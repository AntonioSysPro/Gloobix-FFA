...
class LegacyProtocol extends Protocol
{
    ...
    onStatsRequest ()
    {
        ...
        const legacy = {
            ...
            playersTotal: stats.external + this.settings.worldPlayerBotsPerWorld,
            playersAlive: stats.playing + this.settings.worldPlayerBotsPerWorld,
    ...
    onNewWorldBounds ( range, includeServerInfo )
    {
        ...
        if ( includeServerInfo )
        {
            ...
            writeZTString( writer, `Gloobix ${ this.handle.version }`, this.protocol );
        }
        this.send( writer.finalize() );
    }
